  ...
  return (
    <PublicLayout>
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <h1 className="section-title sm:text-4xl">{about.title}</h1>
        <p className="mt-4 max-w-3xl text-lg text-muted-foreground">{about.intro}</p>

        <section className="mt-12">
          <h2 className="text-xl font-semibold text-gray-900">Professional biography</h2>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-semibold text-gray-900">{about.philosophyTitle}</h2>
          <p className="mt-4 max-w-3xl text-muted-foreground leading-relaxed">
            {about.philosophy}
          </p>
        </section>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-semibold text-gray-900">{about.focusAreasTitle}</h2>
