    ...
    <PublicLayout>
      <div className="section-cream mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <ScrollReveal>
            <div>
              <h1 className="text-3xl font-bold text-foreground sm:text-4xl">{camps.title}</h1>
        ...
        <ScrollReveal className="mt-12">
          <section className="grid gap-8 md:grid-cols-2">
            <div>
              <h2 className="text-xl font-semibold text-foreground">{camps.whyTitle}</h2>
              <p className="mt-3 text-muted-foreground">{camps.whyBody}</p>
            </div>
            <div>
              <h2 className="text-xl font-semibold text-foreground">{camps.whoTitle}</h2>
        ...
        <ScrollReveal className="mt-12" delayMs={80}>
          <section>
            <h2 className="text-xl font-semibold text-foreground">{camps.includesTitle}</h2>
        ...
        <ScrollReveal className="mt-12" delayMs={80}>
          <section>
            <h2 className="text-xl font-semibold text-foreground">{camps.locationTitle}</h2>
        ...
        <ScrollReveal className="mt-12">
          <section>
            <h2 className="text-xl font-semibold text-foreground">Upcoming dates</h2>
            {campsData.length === 0 ? (
                    ...
                    <Card className="border-border/60">
                      <CardHeader>
                        <div className="flex items-start justify-between gap-4">
                          <CardTitle className="text-foreground">{camp.title}</CardTitle>
                          {camp.price != null && (
