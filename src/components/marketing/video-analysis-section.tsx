...
/**
 * Split-screen video analysis — snap-excepted, slide-in from sides on first viewport entry.
 */
      ...
      <div className="split-screen-grid">
        ...
        <div className="split-screen-content-col order-2 lg:order-1">
          <div className="video-analysis-slide-left w-full max-w-xl">
            <div
              className="video-analysis-content-card rounded-xl border border-border/60 bg-card p-5 shadow-sm sm:p-6 lg:p-7"
            >
              <h2
